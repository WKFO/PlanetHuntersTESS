#!/bin/bash -l
echo =========================================================   
echo Job submitted  date = Sat Dec  1 12:49:09 GMT 2018      
date_start=`date +%s`
...
export OMP_NUM_THEADS=1
 /usr/local/shared/slurm/bin/srun -n 50 --mpi=pmi2 --mem-per-cpu=500 nice -n 10 /mnt/zfsusers/nora/soft/PH_make_LC3/./tess_queue.sh 
